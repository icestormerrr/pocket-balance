import {DateComparator} from "@/shared/lib/datetime/DateComparator";
import dayjs from "dayjs";
import {months} from "./const";
import {DateConverter} from "./DateConverter";
import {DateCreator} from "./DateCreator";

export {DateComparator, DateConverter, DateCreator, months};

export function createPeriod(year: number, month?: number): {startDate: Date; endDate: Date} {
  if (month === undefined) {
    // Период — весь год
